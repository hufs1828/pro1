package com.example.samsung.map;
...
//        markerOptions.draggable(true);
        CircleOptions circle = new CircleOptions().center(currentLatLng).radius(100).strokeWidth(2f)
...
//        currentMarker = mGoogleMap.addMarker(markerOptions);
    ...
    public void setDefaultLocation() {
        ...
        //디폴트 위치, Seoul
        LatLng DEFAULT_LOCATION = new LatLng(37.14, 127.12);
